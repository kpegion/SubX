...
units='K'
hasP=0 ;* set this to 1 if variable has a P coordinate 

* Some local system variables
ctlpath='/scratch/kpegion/testSubX/GrADS/ctl' 
datapath='/scratch/kpegion/testSubx/GrADS'
_ncdump='ncdump'
...
* Create a local descriptor with a DSET entry pointing to the URL
  ...
  if (hasP)
    vardec=var' 'Zsize' z,e,t,'s-1',y,x 'title' 'units 
  else
    vardec=var' 0 e,t,'s-1',y,x 'title' 'units 
  endif
