...
* [`generate_full_py_ens_files.ksh`](https://github.com/kpegion/SubX/blob/master/Python/download_data/generate_full_py_ens_files.ksh) creates python files to download each ensemble member for a chosen model etc. These can then be run in parallel. 
